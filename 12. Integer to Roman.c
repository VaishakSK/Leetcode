...
2. If the value starts with 4 or 9 use the subtractive form representing one symbol subtracted from the 
...
char* intToRoman(int num) {
    static char roman[20]; // static so it persists after return
